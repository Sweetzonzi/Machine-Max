...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.VehicleCore` — 载具核心，管理零件图、物理 tick、HP/质量
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.Part` — 零件本体
  - `io.github.sweetzonzi.machine_max.common.vehicle.PartType` — 零件类型定义（耐久度系数、伤害传递系数、功能阈值等）
  - `io.github.sweetzonzi.machine_max.common.vehicle.attr.VariantAttr` — 变体属性，定义零件在不同变体下的子零件结构
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.SubPart` — 子零件，持有碰撞体、连接点、子系统
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.connector.AbstractConnector` — 连接点抽象基类
  - `io.github.sweetzonzi.machine_max.common.vehicle.connector.AdvancedConnector` — 高级连接点（母口），支持关节驱动
  - `io.github.sweetzonzi.machine_max.common.vehicle.connector.SimpleConnector` — 简单连接点（公口）
  - `io.github.sweetzonzi.machine_max.common.vehicle.connector.ConnectorAlignmentHelper` — 连接点对齐辅助
  - `io.github.sweetzonzi.machine_max.common.vehicle.attr.connector.ConnectorAttr` — 连接点属性
  - `io.github.sweetzonzi.machine_max.common.vehicle.attr.connector.JointAttr` — 关节属性（驱动轴、限位等）
...
- **关键类**：
  ...
  - `io.github.sweetzonzi.machine_max.common.vehicle.attr.subsystem.WorkingState` — 子系统工作状态
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.SubsystemController` — 子系统控制器，管理所有子系统、信号通道、能量网
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.signal.Signal` — 信号抽象基类
  - `io.github.sweetzonzi.machine_max.common.vehicle.signal.SignalPort` — 信号端口，挂载在连接点上
  - `io.github.sweetzonzi.machine_max.common.vehicle.signal.SignalChannel` — 命名信号通道
  - `io.github.sweetzonzi.machine_max.common.vehicle.signal.ISignalReceiver` — 信号接收接口
  - `io.github.sweetzonzi.machine_max.common.vehicle.signal.ISignalSender` — 信号发送接口
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.energy.EnergyGrid` — 电力能量网（总线模式）
  - `io.github.sweetzonzi.machine_max.common.vehicle.energy.IEnergyProducer` — 电力生产者接口
  - `io.github.sweetzonzi.machine_max.common.vehicle.energy.IEnergyConsumer` — 电力消费者接口
  - `io.github.sweetzonzi.machine_max.common.vehicle.energy.IEnergyStorage` — 电力储能接口
  - `io.github.sweetzonzi.machine_max.common.vehicle.energy.MechPower` — 机械能（转速+转矩）
  - `io.github.sweetzonzi.machine_max.common.vehicle.energy.MechPowerPort` — 机械能传输端口
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.ObjectManager` — 载具与可破坏对象的全局管理器
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.DestroyableObject` — 可破坏对象基类
  - `io.github.sweetzonzi.machine_max.common.vehicle.DestroyableRigidObject` — 可破坏刚体对象
...
- **关键类**：
  ...
  - `io.github.sweetzonzi.machine_max.common.vehicle.data.BlueprintData` — 蓝图数据
  - `io.github.sweetzonzi.machine_max.common.vehicle.data.AssemblyData` — 装配体数据
  - `io.github.sweetzonzi.machine_max.common.vehicle.data.VehicleData` — 载具完整数据（用于保存/同步）
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.CollisionManager` — 碰撞管理器
  - `io.github.sweetzonzi.machine_max.common.vehicle.collision.CollisionHandler` — 碰撞处理器
  - `io.github.sweetzonzi.machine_max.common.vehicle.collision.CollisionEffectManager` — 碰撞效果管理器
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.interact.InteractBox` — 交互判定区
  - `io.github.sweetzonzi.machine_max.common.vehicle.interact.HitBox` — 击中判定区
...
- **关键类**：
  - `io.github.sweetzonzi.machine_max.common.vehicle.molang.VehicleBinding` — 载具 Molang 绑定
  - `io.github.sweetzonzi.machine_max.common.vehicle.molang.SubPartBinding` — 子零件 Molang 绑定
  - `io.github.sweetzonzi.machine_max.common.vehicle.subsystem.ScriptableSubsystem` — JavaScript 脚本子系统
