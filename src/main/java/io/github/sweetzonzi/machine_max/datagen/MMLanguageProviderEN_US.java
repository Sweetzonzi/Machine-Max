...
public class MMLanguageProviderEN_US extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add("key.machine_max.general.view_vehicle_internal", "Inspect Internal");
        //Key names-Ground
        ...
        this.add("message.machine_max.blueprint_saved", "Blueprint has been saved to the blueprint library");
        this.add("message.machine_max.blueprint_extract.success", "Blueprint extracted, consumed %1$s research points");
        this.add("message.machine_max.blueprint_extract.failed", "Failed to extract blueprint: %1$s");
        this.add("message.machine_max.blueprint_extract.reason.none", "unknown reason");
        this.add("message.machine_max.blueprint_extract.reason.invalid_structure", "invalid blueprint data");
        this.add("message.machine_max.blueprint_extract.reason.missing_parts", "missing content pack parts");
        this.add("message.machine_max.blueprint_extract.reason.insufficient_rp", "insufficient research points");
        this.add("message.machine_max.blueprint_extract.reason.unknown_blueprint", "unknown blueprint");
        this.add("message.machine_max.blueprint_error", "Failed to save blueprint: %1$s");
        this.add("message.machine_max.assembly.locked", "Cannot assemble %1$s: research it first or hold its fabricating blueprint");
        ...
        this.add("gui.machine_max.enter_vehicle_description", "Enter design description (optional)");
        ...
        this.add("gui.machine_max.research.tab.research", "Research");
        this.add("gui.machine_max.research.tab.library", "Library");
        this.add("gui.machine_max.blueprint_library.section.local", "My Designs");
        this.add("gui.machine_max.blueprint_library.section.pack", "Content Pack Blueprints");
        this.add("gui.machine_max.blueprint_library.parts", "parts");
        this.add("gui.machine_max.blueprint_library.template_missing", "template missing");
        this.add("gui.machine_max.blueprint_library.no_materials", "No materials required");
        this.add("gui.machine_max.blueprint_library.material_count", "Have %1$s / Need %2$s");
        this.add("gui.machine_max.blueprint_library.store", "Store");
        this.add("gui.machine_max.blueprint_library.rename", "Rename");
        this.add("gui.machine_max.blueprint_library.tooltip.stats", "Parts %1$s | Mass %2$s kg | Est. cost %3$s RP");
        this.add("gui.machine_max.blueprint_library.tooltip.balance", "Current research points: %1$s");
        this.add("message.machine_max.blueprint_library.no_storable", "No storable vehicle blueprint in inventory");
