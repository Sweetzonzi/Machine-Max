...
public class MMLanguageProviderZH_CN extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add("message.machine_max.blueprint_saved", "蓝图已保存至蓝图库");
        this.add("message.machine_max.blueprint_extract.success", "已取出蓝图，消耗研发点 %1$s");
        this.add("message.machine_max.blueprint_extract.failed", "取出蓝图失败：%1$s");
        this.add("message.machine_max.blueprint_extract.reason.none", "未知原因");
        this.add("message.machine_max.blueprint_extract.reason.invalid_structure", "蓝图数据非法");
        this.add("message.machine_max.blueprint_extract.reason.missing_parts", "缺少内容包零件");
        this.add("message.machine_max.blueprint_extract.reason.insufficient_rp", "研发点不足");
        this.add("message.machine_max.blueprint_extract.reason.unknown_blueprint", "未知蓝图");
        this.add("message.machine_max.blueprint_error", "保存蓝图失败: %1$s");
        this.add("message.machine_max.assembly.locked", "无法装配 %1$s：需先完成对应研发，或持有该零件的制造蓝图");
        ...
        this.add("gui.machine_max.enter_vehicle_description", "设置设计描述（可选）");
        ...
        this.add("gui.machine_max.research.tab.research", "研发");
        this.add("gui.machine_max.research.tab.library", "蓝图库");
        this.add("gui.machine_max.blueprint_library.section.local", "我的设计");
        this.add("gui.machine_max.blueprint_library.section.pack", "内容包蓝图");
        this.add("gui.machine_max.blueprint_library.parts", "零件");
        this.add("gui.machine_max.blueprint_library.template_missing", "模板缺失");
        this.add("gui.machine_max.blueprint_library.no_materials", "无材料需求");
        this.add("gui.machine_max.blueprint_library.material_count", "已有 %1$s / 所需 %2$s");
        this.add("gui.machine_max.blueprint_library.store", "存入库");
        this.add("gui.machine_max.blueprint_library.rename", "改名");
        this.add("gui.machine_max.blueprint_library.tooltip.stats", "零件 %1$s | 质量 %2$s kg | 预估费用 %3$s RP");
        this.add("gui.machine_max.blueprint_library.tooltip.balance", "当前研发点: %1$s");
        this.add("message.machine_max.blueprint_library.no_storable", "背包中没有可入库的载具蓝图");
