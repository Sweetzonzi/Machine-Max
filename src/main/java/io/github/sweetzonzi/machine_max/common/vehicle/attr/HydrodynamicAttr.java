...
public record HydrodynamicAttr(
    ...
    public static final Codec<HydrodynamicAttr> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    Codec.FLOAT.listOf().optionalFieldOf("front_drag", List.of(0.0f,1.0f)).forGetter(HydrodynamicAttr::forward),
                    Codec.FLOAT.listOf().optionalFieldOf("back_drag", List.of(0.0f,1.0f)).forGetter(HydrodynamicAttr::backward),
                    Codec.FLOAT.listOf().optionalFieldOf("left_drag", List.of(0.0f,1.0f)).forGetter(HydrodynamicAttr::leftward),
                    Codec.FLOAT.listOf().optionalFieldOf("right_drag", List.of(0.0f,1.0f)).forGetter(HydrodynamicAttr::rightward),
                    Codec.FLOAT.listOf().optionalFieldOf("up_drag", List.of(0.0f,1.0f)).forGetter(HydrodynamicAttr::upward),
                    Codec.FLOAT.listOf().optionalFieldOf("down_drag", List.of(0.0f,1.0f)).forGetter(HydrodynamicAttr::downward),
