...
public class BasicSubsystemStaticAttr extends AbstractSubsystemStaticAttr {
    ...
    public static final MapCodec<BasicSubsystemStaticAttr> CODEC =
            RecordCodecBuilder.mapCodec(instance -> instance.group(
                    BasicAttr.CODEC.forGetter(attr -> attr.basicAttr)
            ).apply(instance, BasicSubsystemStaticAttr::new));

    public BasicSubsystemStaticAttr(BasicAttr basicAttr) {
...
//            boolean passDamage, // 是否传递伤害至子系统持有者
//            boolean limitDamage // 是否限制伤害传递值至子系统剩余耐久度，例如40伤害，子系统剩余耐久度为20，则只会传递20伤害给持有者
    ) {
...
//                        Codec.BOOL.optionalFieldOf("limit_damage", true).forGetter(BasicAttr::limitDamage)
