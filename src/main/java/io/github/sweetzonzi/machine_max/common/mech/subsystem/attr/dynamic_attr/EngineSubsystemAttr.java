...
import io.github.sweetzonzi.machine_max.common.mech.subsystem.EngineSubsystem;
...
@Getter
public class EngineSubsystemAttr extends BasicSubsystemDynamicAttr {
    ...
    public static final MapCodec<EngineSubsystemAttr> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ...
            RPM_OUTPUT_TARGETS_CODEC.optionalFieldOf("speed_outputs", Map.of("engine_speed", List.of("global", "local"))).forGetter(EngineSubsystemAttr::getRpmOutputTargets)
