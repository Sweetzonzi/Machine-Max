...
public class ResearchRecipeListWidget extends AbstractScrollWidget {
    ...
    private static final int PROGRESS_FG = new Color(96, 176, 120).getRGB();
    ...
    protected void renderContents(
        ...
        for (int i = 0; i < states.size(); i++) {
            ...
            // === 名称 + 版本号 ===
            Component name = Component.translatable(holder.id().toLanguageKey()).append(FabricatingBlueprintItem.buildVersion(Math.max(0 ,state.researchLevel() - 1)));
            ...
            // === 按钮区域 ===
            int btn1X = getX() + width - 2 * BUTTON_WIDTH - 8;
            ...
            g.drawCenteredString(
                    minecraft.font,
                    researching ? "×" : state.researchLevel() > 0 ? "↑" : "\uD83D\uDD2C",
    ...
    public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (hovered!= null && withinContentAreaPoint(mouseX, mouseY))
