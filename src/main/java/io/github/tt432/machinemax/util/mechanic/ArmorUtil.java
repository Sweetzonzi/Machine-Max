package io.github.tt432.machinemax.util.mechanic;
...
public class ArmorUtil {
    ...
    public static float getBlockArmor(Level level, BlockState blockState, BlockPos blockPos) {
        return (float) (10f * (log10(blockState.getBlock().getExplosionResistance() + 1) * blockState.getDestroySpeed(level, blockPos)));
    }
}
