...
import io.github.tt432.machinemax.common.sloarphys.ClientPhysLevel;
...
public class PhysSyncPayloadHandler {
    public static void handler(final PhysSyncPayload payload, final IPayloadContext context) {
        ClientPhysLevel localThread = (ClientPhysLevel) ((IMixinLevel) context.player().level()).machine_Max$getPhysLevel();
