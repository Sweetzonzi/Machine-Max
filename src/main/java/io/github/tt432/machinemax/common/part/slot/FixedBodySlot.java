...
public class FixedBodySlot extends AbstractBodySlot {
    public FixedBodySlot(String name, ModelPartBody slotOwnerElement, PosRot childElementAttachPoint) {
        super(name, slotOwnerElement, childElementAttachPoint);
    }

    @Override
    protected void attachJoint(ModelPartBody element, String childPartAttachPoint) {
