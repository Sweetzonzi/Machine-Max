package io.github.tt432.machinemax.common.vehicle.port;
...
import io.github.tt432.machinemax.common.phys.body.PartPortAttachPointBody;
...
//            partPort.getSubPart().getBody().setPosition(pos);//子部件指定安装点对齐槽位安装点
//            //处理安装角
//            DQuaternion rot = getWorldAttachRot(partPort);
//            partPort.getSubPart().getBody().setQuaternion(rot);//调整姿态
