...
import io.github.tt432.machinemax.client.OldPartMolangScope;
import io.github.tt432.machinemax.common.entity.old.entity.OldPartEntity;
import io.github.tt432.machinemax.common.vehicle.old.slot.BasicModuleSlot;
...
public abstract class AbstractPart implements Iterable<AbstractPart>, IPartPhysParameters {
    //渲染属性
    public OldPartMolangScope molangScope;//用于储存作用域为零部件本身的Molang变量
    //基础属性
    @Getter
    @Setter
    protected OldPartEntity attachedEntity;//此部件附着的实体
    @Getter
