...
public class CarControllerSubsystemAttr extends AbstractSubsystemAttr {
    ...
    public CarControllerSubsystemAttr(List<String> controlInputKeys, Vec3 steeringCenter,boolean manualGearShift , Map<String, List<String>> engineControlOutputTargets, Map<String, List<String>> wheelControlOutputTargets, Map<String, List<String>> gearboxControlOutputTargets) {
