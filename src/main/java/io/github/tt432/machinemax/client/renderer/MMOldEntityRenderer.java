...
public class MMOldEntityRenderer extends EntityRenderer<OldPartEntity> {

    protected MMOldEntityRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(OldPartEntity pEntity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(OldPartEntity entity) {
